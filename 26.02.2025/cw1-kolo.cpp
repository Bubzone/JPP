...
class kolo
{
   public:
      ...
      //----- funkcje do wykonywania obliczeñ  -------------
      float obliczPole();
      float obliczObwod();
   private:
...
// funkcja sk³adowa zwraca pole powierzchni ko³a
...
int main()
{
   ...
   // funkcje sk³adowe uruchamiane przy u¿yciu operatora kropka
   ...
   kolo *wsk;            // wskaŸnik na obiekt klasy kolo
   wsk = new kolo(1.0);  // obiekt tworzony dynamicznie (przy pomocy wskaŸnika)
   // funkcje sk³adowe uruchamiane przy u¿yciu operatora strza³ka
